...
bool ModuleSceneSpace::Start()
{
	...
	App->enemies->AddEnemy(ENEMY_TYPES::BROWNCOOKIES, 800, 80);
	App->enemies->AddEnemy(ENEMY_TYPES::BROWNCOOKIES, 825, 80);
	App->enemies->AddEnemy(ENEMY_TYPES::BROWNCOOKIES, 840, 80);
	App->enemies->AddEnemy(ENEMY_TYPES::BROWNCOOKIES, 865, 80);
