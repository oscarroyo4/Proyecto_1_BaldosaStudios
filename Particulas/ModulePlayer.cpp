...
update_status ModulePlayer::Update()
{
	...
	if (App->input->keyboard[SDL_SCANCODE_G] == KEY_STATE::KEY_REPEAT)
	{
		...
		App->particles->AddParticle(App->particles->smallfire, position.x + 60, position.y - 45, 0, 500, 0, 0);

		App->particles->AddParticle(App->particles->midfire, position.x + 60, position.y - 72, 0, 600, 0, 0);
		App->particles->AddParticle(App->particles->smallfire, position.x + 75, position.y - 45, 0, 600, 0, 0);

		App->particles->AddParticle(App->particles->bigfire, position.x + 60, position.y - 100, 0, 700, 0, 0);
		App->particles->AddParticle(App->particles->midfire, position.x + 75, position.y - 72, 0, 700, 0, 0);
		App->particles->AddParticle(App->particles->smallfire, position.x + 90, position.y - 45, 0, 700, 0, 0);

		App->particles->AddParticle(App->particles->midfire, position.x + 60, position.y - 72, 0, 800, 0, 0);
		App->particles->AddParticle(App->particles->bigfire, position.x + 75, position.y - 100, 0, 800, 0, 0);
		App->particles->AddParticle(App->particles->midfire, position.x + 90, position.y - 72, 0, 800, 0, 0);
		App->particles->AddParticle(App->particles->smallfire, position.x + 105, position.y - 45, 0, 800, 0, 0);

		App->particles->AddParticle(App->particles->smallfire, position.x + 60, position.y - 45, 1, 1000, 1, 0);
		App->particles->AddParticle(App->particles->midfire, position.x + 75, position.y - 72, 1, 1000, 1, 0);
		App->particles->AddParticle(App->particles->bigfire, position.x + 90, position.y - 100, 1, 1000, 1, 0);
		App->particles->AddParticle(App->particles->midfire, position.x + 105, position.y - 72, 1, 1000, 1, 0);
		App->particles->AddParticle(App->particles->smallfire, position.x + 120, position.y - 45, 1, 1000, 1, 0);
	}
